...
CREATE TABLE Autorizacion_usuario(
    ...
    id_sistema_usuario INT NOT NULL,
...
CREATE TABLE Formula_optica (
    ...
    id_paciente INT,
    esfera_ojo_derecho_e_izquierdo INT,
    cilindro_ojo_derecho_e_izquierdo INT,
    eje_ojo_derecho_e_izquierdo INT,
