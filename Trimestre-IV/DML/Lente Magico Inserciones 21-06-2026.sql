...
VALUES ('uvs_yess', 'yiacs@gmail.com', Sha2('Contraseña',256), TRUE, 'es', 'ACT-1111', '1787538', '2026-02-25 12:30:00');

INSERT INTO Usuario (login, correo, contraseña, activar_usuario, clave_idioma, clave_activacion, llave_reinicio, hora_reinicio) 
VALUES ('mkdf_jhj', 'jhj@hotmail.com', Sha2('cjbvdsh54@',256), TRUE, 'es', 'ACT-2222', 'hjdsf5646', '2026-01-25 10:30:00');

INSERT INTO Usuario (login, correo, contraseña, activar_usuario, clave_idioma, clave_activacion, llave_reinicio, hora_reinicio) 
VALUES ('usfo_dges', 'dges@gmail.com', Sha2('Cññññjdgra3@',256), TRUE, 'es', 'ACT-3333', 'jhvfejf878', '2026-05-25 16:30:00');

INSERT INTO Usuario (login, correo, contraseña, activar_usuario, clave_idioma, clave_activacion, llave_reinicio, hora_reinicio) 
VALUES ('uksdo_djds', 'djds@gmail.com', Sha2('Cñjakdnv3@',256), TRUE, 'es', 'ACT-4444', 'jhsfijjf87', '2026-03-27 09:30:00');

INSERT INTO Usuario (login, correo, contraseña, activar_usuario, clave_idioma, clave_activacion, llave_reinicio, hora_reinicio) 
VALUES ('kdasfo_diys', 'diys@gmail.com', Sha2('Cññññjjgadjyg',256), TRUE, 'es', 'ACT-5555', 'jhvfdsfbv845', '2026-05-07 08:40:00');
